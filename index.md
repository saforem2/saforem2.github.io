...
:::: {.columns  style="margin-bottom:-1.75rem;"}

::: {.column width="55%" style="margin-top: -0.0em;"}

# [{{< fa regular id-badge >}}]{.green-text} About Me


[I use machine learning to accelerate scientific discovery[^1].]{style="font-size:1.33em; margin-bottom: 0rem;"}

:::

[^1]: [Mostly getting supercomputers to talk to each other {{< fa solid network-wired >}}]{.dim-text style="font-size: 1.25em; margin-bottom: -1rem;margin-top:-1rem!important;"}


::: {.column width="45%" style="margin-top: 1.5em;"}
...
performance computing.]{style="font-size:1.1rem;"}
...
## [{{< fa solid graduation-cap >}}]{.green-text} [Education](https://scholar.google.com/citations?user=vV_1zDwAAAAJ&hl=en)
...
## [{{< fa solid building >}}]{.blue-text} [Experience](https://samforeman.me/files/resume.pdf)
...
## [{{< fa solid bullhorn >}}]{.purple-text} Wait, there's more!
