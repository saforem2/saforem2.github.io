...
<!-- ::: {layout-ncol=2 style="text-align:left;"} -->
<!---->
<!-- ::: {#first-column} -->
<!---->
<!-- ![](https://saforem2.github.io/qmd/dsblog_files/figure-html/cell-4-output-1.svg) -->
<!---->
<!-- `GPT-25B` Model -->
<!-- ::: -->
<!---->
<!-- ::: {#second-column} -->
<!---->
<!-- ![](https://saforem2.github.io/qmd/dsblog_files/figure-html/cell-4-output-2.svg) -->
<!---->
<!-- `GPT-33B` Model -->
<!-- ::: -->
<!---->
...
<!-- <details closed><summary><b>Results</b></summary> -->
...
>
> 3.  (ideally one with `tensorflow, pytorch [horovod,deepspeed]`
>     already installed)
...
- [`ALCF/models.sh`](./ALCF/models.sh): Model architectures are defined
  in
- [`ALCF/args.sh`](./ALCF/args.sh): Runtime arguments
- `ALCF/{`[`setup.sh`](./ALCF/setup.sh)[`launch.sh`](./ALCF/launch.sh)`}`
  Options for environment setup / launching the executable are in
...
![GPT-`25B`
Model](dsblog-md_files/figure-commonmark/cell-4-output-1.svg)

![GPT-`33B`
Model](dsblog-md_files/figure-commonmark/cell-4-output-2.svg)

Figure 2: Pretraining with long sequence support across different model
...
A100-40GB nodes, connected through 8 HDR InfiniBand (200Gb/s per HDR).
