...
::: {.callout-tip icon=false title="[{{< fa solid music >}} $\hspace{1pt}$ Now Playing:]{.green-text}" collapse="true" style="width:100%; border: 1px solid var(--mygreen)!important;"}
...
## [{{< fa solid hourglass-end >}}]{.dim-text} Appendix
